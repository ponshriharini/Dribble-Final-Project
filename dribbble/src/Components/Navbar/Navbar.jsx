...
function Navbar({className}) {
    ...
    const toggleMenu = () => {
        ...
        if (!menuOpen) {
            ...
            document.documentElement.classList.add('menu-opened'); // Add dull effect
        } else {
            document.body.style.overflow = 'auto';    // Enable scroll
            document.documentElement.classList.remove('menu-opened'); // Remove dull effect
        }
    };
    ...
    return ( 
        <div className={`navbar-main-container ${className}`}>
            ...
            <div className={`navbar-container ${menuOpen ? "menu-open" : ""}`}>
                ...
                <div className="navbar-logo">
                    <a href="/">
                        <svg xmlns="http://www.w3.org/2000/svg" width="90" height="45" viewBox="0 0 210 59" fill="none">
                ...
                <div className="search-actions">
                    <div className="search-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 17 17" fill="none" role="img" className="icon nav-v2-search__icon">
                    ...
                    <div className="search-form">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 17 17" fill="none" role="img" className="icon nav-v2-search__icon">
                            <path d="M1.5 7.75C1.5 9.4076 2.15848 10.9973 3.33058 12.1694C4.50269 13.3415 6.0924 14 7.75 14C9.4076 14 10.9973 13.3415 12.1694 12.1694C13.3415 10.9973 14 9.4076 14 7.75C14 6.0924 13.3415 4.50269 12.1694 3.33058C10.9973 2.15848 9.4076 1.5 7.75 1.5C6.0924 1.5 4.50269 2.15848 3.33058 3.33058C2.15848 4.50269 1.5 6.0924 1.5 7.75V7.75Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                            <path d="M12.814 12.8132L15.5 15.4999" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                        </svg>
                            ...
                            <div className="dropdown-options-container name-dropdown-container">
                                <div className="dropdown-options name-dropdown">
                                    ...
                                    <a href="#">
                                        ...
                                        <p className="name-dropdown-header">Settings</p>
                                    </a>
                                    <hr />
                                    <a href="#">
                                        <p className="name-dropdown-header" onClick={() => SignOut()}>Sign Out</p>
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div className={`navbar-collapse-menu ${menuOpen ? "show" : ""}`}>
                    <hr style={{margin: "0px"}} />
                    <div className="menu-content">
                        <a href="#">Find designers</a>
                        <div className="subheadings">
                            <div className="subheading-content sc-1">
                                <a href="#">Designer search</a>
                                <p>Quickly find your next designer</p>
                            </div>
                            <div className="subheading-content sc-2">
                                <a href="#">Post a job</a>
